...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    const result = await db.query(
      ...
      [uuid(), req.user.id, categoryId, type, title, slug, description, price || null, currency || "GHS", priceLabel || null, isNegotiable || false, country || "GH", city || null, locationText || null, isRemote || false]
    );
