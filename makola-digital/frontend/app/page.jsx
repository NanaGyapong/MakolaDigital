  ...
  return (
    <div style={{ fontFamily: "'DM Sans', 'Segoe UI', sans-serif", background: "#0D0D0D", minHeight: "100vh", color: "#F0EDE8" }}>
      ...
      <div style={{ padding: isMobile ? "28px 16px 20px" : "40px 32px 24px" }}>
        {/* World Cup Banner */}
        <div style={{ background: "linear-gradient(135deg, rgba(0,100,0,0.12), rgba(232,83,58,0.08))", border: "1px solid rgba(45,158,107,0.3)", borderRadius: 16, padding: "16px 20px", marginBottom: 28, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}><div style={{ display: "flex", alignItems: "center", gap: 12 }}><span style={{ fontSize: 32 }}>🏆</span><div><div style={{ fontWeight: 900, fontSize: 16, color: "#F0EDE8" }}>🇬🇭 Ghana vs Panama 🇵🇦 — Wednesday · FIFA World Cup 2026</div><div style={{ fontSize: 13, color: "rgba(240,237,232,0.6)", marginTop: 2 }}>Get your jerseys, TVs & snacks ready for the Black Stars! ⚽🌍</div></div></div><a href="/search?q=jersey" style={{ background: "#2D9E6B", color: "#fff", textDecoration: "none", padding: "8px 18px", borderRadius: 20, fontSize: 13, fontWeight: 700 }}>Shop Now ⚽</a></div>
